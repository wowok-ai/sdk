...
export declare const graphql: import("gql.tada").GraphQLTadaAPI<{
    ...
    types: {
        ...
        Feature: {
            name: "Feature";
            enumValues: "ANALYTICS" | "COINS" | "DYNAMIC_FIELDS" | "NAME_SERVICE" | "SUBSCRIPTIONS" | "SYSTEM_STATE";
        };
        GasCoin: {
            kind: "OBJECT";
            name: "GasCoin";
        ...
        ObjectKind: {
            name: "ObjectKind";
            enumValues: "NOT_INDEXED" | "LIVE" | "HISTORICAL" | "WRAPPED_OR_DELETED";
        };
        ObjectOwner: {
            kind: "UNION";
            name: "ObjectOwner";
            fields: {};
            possibleTypes: "AddressOwner" | "Immutable" | "Parent" | "Shared";
        };
        ObjectRef: {
            kind: "INPUT_OBJECT";
            name: "ObjectRef";
