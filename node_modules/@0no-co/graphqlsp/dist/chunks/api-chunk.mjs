  ...
  return s = o.flatMap((s => {
    ...
    var u, _loop2 = function() {
      if (!n && (b.isReturnStatement(o) || b.isArrowFunction(o))) {
        ...
        if (f && (b.isFunctionDeclaration(f) || b.isFunctionExpression(f) || b.isArrowFunction(f))) {
          var d = f.parameters[s ? 1 : 0];
          if (d) {
            var v = crawlScope(d.name, l, i, r, a, !0);
            if (b.isVariableDeclaration(h.parent) && !u) {
              var g = crawlScope(h.parent.name, l, i, r, a, !0);
              v.push(...g);
            }
            return {
              v
        ...
        var S = [ ...l, o.argumentExpression.text ].join(".");
    ...
    i.forEach((i => {
      ...
      if (i.importClause.namedBindings && b.isNamespaceImport(i.importClause.namedBindings)) {
        ...
        if (c) {
          ...
          var d = getFragmentsInSource(p, r, t).map((e => e.name.value));
...
var generateHashForDocument = (e, t, i, r) => {
  if (r) {
    ...
    var s = print(parse(n));
    return A("sha256").update(s).digest("hex");
  } else {
    var o = getSource(e, i);
    var {fragments: l} = findAllCallExpressions(o, e);
    var u = resolveTemplate(t, i, e).combinedText;
    var h = parse(u);
    var f = new Set;
    visit(h, {
      FragmentSpread: e => {
    ...
    return A("sha256").update(print(parse(c))).digest("hex");
  }
};
