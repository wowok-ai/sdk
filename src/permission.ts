...
export const PermissionInfo : PermissionInfoType[] = [
    ...
    {index:PermissionIndex.repository_add_remove_policies, name:'Add/Remove Policy', description:'add or remove policy', module: 'repository'},
    ...
    {index:PermissionIndex.repository_reference, name:'Reference', description:'build machine', module: 'repository'},
    ...
    {index:PermissionIndex.service_set_add_reduce_stock, name:'Inventory', description:'Add/Reduce/Set inventory', module: 'service'},
    {index:PermissionIndex.service_set_payee, name:'Payee', description:'build machine', module: 'service'},
    {index:PermissionIndex.service_repository, name:'Repository', description:'build machine', module: 'service'},
    {index:PermissionIndex.service_withdraw_guards, name:'Withdraw Guard', description:'Add, remove withdraw guards', module: 'service'},
    {index:PermissionIndex.service_refund_guards, name:'Refund Guard', description:'build machine', module: 'service'},
    ...
    {index:PermissionIndex.service_customer_required, name:'Buyer info', description:'build machine', module: 'service'},
    ...
    {index:PermissionIndex.reward_guard, name:'Guard', description:'build machine', module: 'reward'},
    ...
    {index:PermissionIndex.machine_repository, name: 'Repository', description:'machine_add_repository', module: 'machine'},
    {index:PermissionIndex.machine_clone, name: 'Clone', description:'machine_clone', module: 'machine'},
    {index:PermissionIndex.machine_node, name: 'Node', description:'machine_add_node/2', module: 'machine'},
