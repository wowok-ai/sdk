...
export class Guard {
    ...
    static QUERIES:any[] = [ 
        ...
        [MODULES.withholding, 'Permission', 600, [], ValueType.TYPE_ADDRESS, 'Permission object address.', []],       
        [MODULES.withholding, 'Withholdings Remaining', 601, [], ValueType.TYPE_U64, 'Number of withholdings to be claimed.', []],
        [MODULES.withholding, 'Withholding Count Supplied', 602, [], ValueType.TYPE_U64, 'Total withholdings supplied.', []],   
        [MODULES.withholding, 'Guard Count', 603, [], ValueType.TYPE_U64, 'The number of claiming guards.', []],   
        [MODULES.withholding, 'Has Guard', 604, [ValueType.TYPE_ADDRESS], ValueType.TYPE_BOOL, 'Whether a claiming guard is set up?', ['address']],       
        [MODULES.withholding, 'Guard Portion', 605, [ValueType.TYPE_ADDRESS], ValueType.TYPE_U64, 'The portions of withholdings, that can be claimed if a certain guard condition is met.', ['address']],
        [MODULES.withholding, 'Deadline', 606, [], ValueType.TYPE_U64, 'The expiration time of claiming.', []],   
        [MODULES.withholding, 'Has Claimed by An Address', 607, [ValueType.TYPE_ADDRESS], ValueType.TYPE_BOOL, 'Whether a certain address has claimed withholdings?', ['address']], 
        [MODULES.withholding, 'Portions Claimed by An Address', 608, [ValueType.TYPE_ADDRESS], ValueType.TYPE_U64, 'The portions of withholdings that have been claimed by a certain address.', []],
        [MODULES.withholding, 'Number of Addresses Claimed', 609, [], ValueType.TYPE_U64, 'Number of addresses that have claimed withholdings.', []],   
        [MODULES.withholding, 'Is Sponsor', 620, [ValueType.TYPE_ADDRESS], ValueType.TYPE_BOOL, 'Whether an address is a sponsor of the withholding pool?', ['address']], 
        [MODULES.withholding, 'Portions by A Sponsor', 611, [ValueType.TYPE_ADDRESS], ValueType.TYPE_U64, 'The portions of sponsorship withholding pools for a certain address.', ['address']], 
        [MODULES.withholding, 'Number of Sponsors', 612, [], ValueType.TYPE_U64, 'Number of sponsors in the sponsorship withholding pool.', []],
        [MODULES.withholding, 'Allow Repeated Claims', 613, [], ValueType.TYPE_BOOL, 'Whether to allow repeated claims?', []],  
